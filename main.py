...
class Grafica(Frame):
    def __init__(self, master, *arg):
        ...
        self.fig, ax = plt.subplot(facecolor =colorA , dpi = 100, figsize = (4,2))
    ...
    def widgets(self):
        ...
        self.bt_desconectar = Button(frame1, text = 'Desconectar',state= 'disabled', font = ('Arial', 12, 'bold'), width = 12, bg = 'red2', command = self.desconectar_serial)
